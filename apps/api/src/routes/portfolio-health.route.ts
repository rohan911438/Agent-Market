import { PortfolioHealthRequestSchema, PortfolioHealthResponseSchema, type PortfolioHealthResponse } from '@agentmarket/shared-types';
...
export function registerPortfolioHealthRoute(server: FastifyInstance, ctx: AppContext): void {
  registerMeteredRoute({
    ...
    handler: async ({ body: requestBody, request }) => {
